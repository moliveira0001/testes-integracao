...
namespace Alura.CoisasAFazer.Services.Handlers
{
    public class CadastraTarefaHandler
    {
        ...
        public CadastraTarefaHandler(IRepositorioTarefas _repo, ILogger<CadastraTarefaHandler> _logger)
        {
            this._repo = _repo;
            this._logger = _logger;// new LoggerFactory().CreateLogger<CadastraTarefaHandler>();
        }
